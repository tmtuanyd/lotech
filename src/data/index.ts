...
export const COMPANY = {
  ...
  address1: "50 đường Tân Thụy – Phúc Lợi – Hà Nội",
  address2: "Số nhà 90, Ngõ 74 Đường Hữu Hưng, TDP Ngang, Phường Tây Mỗ, Thành phố Hà Nội",
...
export const SOLUTIONS = [
  {
    id: "camera-ai",
    slug: "giam-sat-an-ninh-thong-minh",
    title: "Giám sát an ninh thông minh",
    description:
      "Giải pháp giám sát an ninh tổng thể cho trạm điện, nhà máy và hạ tầng trọng yếu với Camera AI, nhận diện đối tượng và điều hành tập trung từ xa.",
    icon: "📷",
    color: "#0D2B5E",
    tags: ["AI Camera", "An ninh", "24/7"],
    image: "https://images.unsplash.com/photo-1565043589221-1a6fd9ae45c7?w=800&q=80",
    features: ["Tích hợp Camera AI nhận diện đối tượng", "Phát hiện xâm nhập và cảnh báo bất thường", "Giám sát, điều hành tập trung từ xa", "Nâng cao mức độ an toàn và giảm chi phí vận hành"],
  },
  {
    id: "giam-sat-nhiet",
    slug: "giam-sat-nhiet-thiet-bi-dien",
    title: "Giám sát nhiệt thiết bị điện",
    description:
      "Giám sát nhiệt trực tuyến cho máy biến áp, thanh cái, dao cách ly, đầu cáp và tủ điện bằng camera nhiệt và cảm biến thông minh.",
    icon: "🌡️",
    color: "#1A4490",
    tags: ["Thermal", "Predictive", "Online 24/7"],
    image: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800&q=80",
    features: ["Theo dõi online 24/7", "Cài đặt theo dõi điểm nhiệt tự động", "Cảnh báo theo nhiều mức độ", "Hỗ trợ bảo trì dự báo và nâng cao độ tin cậy cung cấp điện"],
  },
  {
    id: "bao-ve-hang-rao",
    slug: "bao-ve-hang-rao-hanh-lang-tram-dien",
    title: "Bảo vệ hàng rào và hành lang trạm điện",
    description:
      "Giải pháp bảo vệ hàng rào an ninh, hành lang tuyến điện và khu vực trọng yếu bằng cảm biến hàng rào điện tử và tia hồng ngoại.",
    icon: "🛡️",
    color: "#E87722",
    tags: ["Perimeter", "Hành lang", "Cảnh báo"],
    image: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=800&q=80",
    features: ["Cảnh báo xâm nhập tức thì qua âm thanh và phần mềm quản lý", "Chống báo động giả", "Chịu được điều kiện thời tiết khắc nghiệt", "Đảm bảo an ninh vận hành liên tục cho công trình điện"],
  },
  {
    id: "nguon-dien-tu-dong-hoa",
    slug: "nguon-dien-va-tu-dong-hoa",
    title: "Nguồn điện và tự động hóa",
    description:
      "Thiết kế, chế tạo và tích hợp hệ thống máy biến áp, tủ điện phân phối, tủ điều khiển, PLC và SCADA cho nhà máy và hạ tầng kỹ thuật.",
    icon: "⚙️",
    color: "#0D2B5E",
    tags: ["Nguồn điện", "PLC/SCADA", "Tự động hóa"],
    image: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    features: ["Giải pháp tổng thể từ cấp nguồn đến điều khiển thiết bị", "Giám sát và vận hành tập trung", "Phù hợp nhà máy, khu công nghiệp và hệ thống cấp nước", "Nâng cao hiệu quả sản xuất, tối ưu chi phí vận hành"],
  },
  {
    id: "giam-sat-tu-dc",
    slug: "giam-sat-tu-dien-mot-chieu-dc",
    title: "Giám sát tủ điện một chiều (DC)",
    description:
      "Thiết kế và thi công hệ thống giám sát nguồn điện một chiều cho tủ DC tại các trạm 110kV và 220kV.",
    icon: "🔋",
    color: "#1A4490",
    tags: ["DC System", "110-220kV", "Cảnh báo"],
    image: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=800&q=80",
    features: ["Theo dõi điện trở cách điện tủ DC", "Phát hiện chạm đất", "Cảnh báo để xử lý và sa thải phụ tải khi cần", "Hỗ trợ đảm bảo vận hành an toàn"],
  },
  {
    id: "giam-sat-ac-quy",
    slug: "giam-sat-nguon-ac-quy-tram-truyen-tai",
    title: "Giám sát nguồn ắc quy trạm truyền tải",
    description:
      "Giám sát nội trở, nhiệt độ và điện áp từng cell ắc quy giúp dự báo hư hỏng và bảo đảm nguồn dự phòng luôn sẵn sàng.",
    icon: "🔋",
    color: "#1A4490",
    tags: ["Battery", "Cell Monitoring", "Dự phòng"],
    image: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=800&q=80",
    features: ["Giám sát nội trở, nhiệt độ, điện áp từng cell ắc quy", "Dự báo sớm tình trạng hư hỏng bình", "Hỗ trợ thay thế kịp thời", "Đảm bảo hoạt động an toàn, liên tục cho nguồn dự phòng"],
  },
  {
    id: "dien-mat-troi",
    ...
    description:
      "Thiết kế và thi công trọn gói hệ thống điện mặt trời cho nhà xưởng, tòa nhà và trang trại với hiệu suất vận hành tối ưu.",
    icon: "☀️",
    color: "#F5A623",
    tags: ["Solar", "Thi công trọn gói", "Bảo trì"],
    image: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80",
    features: ["Thiết kế và thi công trọn gói hệ thống solar", "Tối ưu hiệu suất năng lượng", "Giảm chi phí vận hành", "Hỗ trợ kỹ thuật và bảo trì lâu dài"],
  },
];
